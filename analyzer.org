...
#+begin_src python :tangle ${BUILDDIR}/analyzer.py
  ...
  from semantic import Expression, Assignment, Identifier, Literal, Delimiter, Call, AndExpression, OrExpression, NotExpression, EqualsExpression, NotEqualToExpression, LessThanExpression, LessThanOrEqualToExpression, GreaterThanExpression, GreaterThanOrEqualToExpression, Fun, Var, Type, UnionType, ListType, MapType
